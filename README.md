...
graph TD
    ...
    subgraph Database & Storage
        Identity & User & Course & Media -->|Read/Write| MySQL[("MySQL DB <br> (Port 3306)")]
        User & Course -->|Cache/Session| Redis[("Redis Cache <br> (Port 6379)")]
...
### 4.2 Cấu trúc thư mục Backend (Repository Directory Structure)
