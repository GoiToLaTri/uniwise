...
public class SecurityConfig {
    ...
    // Định nghĩa các endpoint public
    ...
    @Bean
    AuthenticationEntryPoint authenticationEntryPoint(@org.springframework.context.annotation.Lazy ObjectMapper objectMapper) {
        // Trả về lỗi 401 Unauthorized khi chưa xác thực hoặc token không hợp lệ
        return new CustomAuthenticationEntryPoint(objectMapper);
    }

    @Bean
    AccessDeniedHandler accessDeniedHandler(@org.springframework.context.annotation.Lazy ObjectMapper objeccMapper) {
